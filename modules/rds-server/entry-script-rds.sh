...
sudo docker run -d --restart unless-stopped -v /tmp/container-config:/home/container-config -v /tmp:/tmp --name RDS  rhastie/nmos-cpp:latest  
...
sudo docker run -d --restart unless-stopped --v="/tmp/UserConfig.py:/config/UserConfig.py" --name NMOS-TESTING amwa/nmos-testing
